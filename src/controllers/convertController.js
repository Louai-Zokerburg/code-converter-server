...
const generatePrompt = (sourceLang, targetLang, sourceCode) => {
  return `convert this piece of code from ${sourceLang.trim()} programming language to ${targetLang} programming language and return back only the converted code, 
  this is the code: ${sourceCode}`;
};
